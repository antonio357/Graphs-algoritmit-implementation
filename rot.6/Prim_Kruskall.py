...
class TestGrafo(unittest.TestCase):
    ...
    def test_Prim(self):
        ...
        self.assertEqual(self.g_l1.Prim(), "não é conexo")
    ...
    def test_opPrim(self):
        ...
        self.assertEqual(self.g_l1.opPrim(), "não é conexo")
    ...
    def test_Kruskall(self):
        ...
        self.assertEqual(self.g_l1.Kruskall(), "não é conexo")
        self.assertEqual(self.g_l4.Kruskall(), "não é conexo")
    ...
    def test_Kruskall_op(self):
        ...
        self.assertEqual(self.g_l1.opKruskall(), "não é conexo")
        self.assertEqual(self.g_l4.opKruskall(), "não é conexo")
